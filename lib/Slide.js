...
function Slide(props) {
  ...
  var classes = props.classes,
      ...
      subtitleTypographyProps = props.subtitleTypographyProps,
      media = props.media,
      ...
      other = _objectWithoutProperties(props, ['classes', 'ButtonProps', 'titleTypographyProps', 'subtitleTypographyProps', 'media', 'mediaBackgroundStyle', 'subtitle', 'title', 'mobile', 'landscape', 'label', 'onStart']);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _extends({ variant: 'h5', className: classes.title }, titleTypographyProps),
        title
      ),
      _react2.default.createElement(
        _Typography2.default,
        _extends({ variant: 'h6', className: classes.subtitle }, subtitleTypographyProps),
        subtitle
      )
    ),
...
Slide.propTypes = {
  ...
  subtitleTypographyProps: _propTypes2.default.object,
  /**
