...
function Slide(props) {
  ...
  var classes = props.classes,
      ...
      other = _objectWithoutProperties(props, ['classes', 'ButtonProps', 'media', 'mediaBackgroundStyle', 'subtitle', 'title', 'mobile', 'landscape', 'label', 'onStart']);
...
Slide.propTypes = {
   ...
   */
  subtitle: _propTypes2.default.node.isRequired,
  /**
   * Title of the slide.
   */
